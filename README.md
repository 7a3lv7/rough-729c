...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/rough-729c)
...
```bash
npm create cloudflare@latest -- --template=cloudflare/templates/rough-729c
```

A live public deployment of this template is available at [https://rough-729c.templates.workers.dev](https://rough-729c.templates.workers.dev)
